...
const Contact = () => {
    ...
    <div id="contact" className='w-full h-[90%] flex  flex-col justify-center items-center'>
        <div className='md:w-[600px] w-[350px] text-center' data-aos="fade-up" data-aos-duration="2000">
            ...
            <a href="mailto:rickylaa@hotmail.com" className="relative mt-5 inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-accent transition duration-300 ease-out border-2 border-accent rounded shadow-md group">
                ...
                <span className="absolute flex items-center justify-center w-full h-full text-accent transition-all duration-300 transform group-hover:translate-x-full ease">Send Email</span>
