...
function App() {
  ...
  return (
    <div className="bg-primary h-screen">
      ...
      <Contact/>
      <Footer/>
      <div className="fixed bottom-5 left-5 flex gap-6 z-10">
        <a href="https://github.com/Laxunie" target="_blank" rel="noreferrer">
          <svg className='md:w-[40px] cursor-pointer w-[30px] hover:fill-white duration-200' viewBox="0 0 128 128">
        ...
        <a href="https://www.linkedin.com/in/ricky-la-9aa77715a/" target="_blank" rel="noreferrer">
          <svg className='md:w-[40px] cursor-pointer w-[30px] hover:fill-white duration-200' viewBox="0 0 128 128">
